<div class="coll_list">
	...
	<small>Publish : <?=show_date($coll->p_date)?></small>
		<a href="<?=site_url('backend/store/b_collection/detail/'.$c->id);?>"><img src="<?=site_url('store/product/thumb/260-100-crop/dir/assets/modules/store/collection_img/'.$coll->img_path);?>" /></a>
