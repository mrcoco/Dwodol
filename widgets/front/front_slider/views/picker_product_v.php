...
<?$prod = modules::run('store/product/api_getbyid', $prod , array('media'), 'l_desc');?>
	<div class="item">
		<div class="item_img">
			<a href="<?=site_url('store/prod/'.element('product', $prod)->id);?>"><img class="prod_img ctr" src="<?=site_url('store/product/thumb/310-320-crop/dir/assets/modules/store/product_img/'.element('media', $prod)->path);?>" alt="<?=element('product', $prod)->name?>"></a>
