...
*/
$route['backend/login'] = "backend/b_auth/login";
$route['backend/login/(:any)'] = "backend/b_auth/login/$1";
$route['backend/logout'] = "backend/b_auth/logout";
...
//$route['store/prod/(:any)'] = "store/prod/$1";
