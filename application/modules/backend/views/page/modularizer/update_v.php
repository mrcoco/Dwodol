<div class="widget_form grid_500 ctr form-Ui box2">
	<form action="" method="post" accept-charset="utf-8">
		...
		<div class="inputSet">
				...
				<div class="input">
				<?=form_dropdown('mod_par_hide_title', array('y' => 'yes', 'n' => 'no'), $widget->mod_param->hide_title);?>
				</div>
				<div class="clear"></div>
		</div>
		</div>
	...
	<?=widget_helper::run($widget->state.'/'.$widget->widget_name.'/'.$widget->widget_name.'/update',$widget->parameter)?>
		</div>
		<p><input type="submit" name="update" class="button" value="Continue &rarr;"></p>
	</form>
</div>