...
<div class="item <?=$type;?>">
	...
	<a href="<?=site_url('store/collection/'.$coll->id.'/'.nice_strlink($coll->name))?>">
		<img src="<?=site_url('store/product/thumb/680-250-crop/dir/assets/modules/store/collection_img/'.$coll->img_path);?>" />
	</a>
	</div>
