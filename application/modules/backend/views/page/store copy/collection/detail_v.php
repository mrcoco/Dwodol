...
<div class="mainData grid_550 left">
	<div class="store/collection_img">
		<img width="550" src="<?=site_url('store/product/thumb/550-100-crop/dir/assets/modules/store/collection_img/'.$coll->img_path);?>">
	</div>
	...
	<?foreach($items->result() as $item):?>
		...
		<div id="<?=$item->id;?>" class="coll_item mb10">
			...
			<div class="right tool">
				...
				<a href="<?=site_url('store/prod/'.$item->product_id);?>"><span class="view act"></span></a>
