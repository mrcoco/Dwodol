<div class="grid_500 ctr box2">
	<div class="form-Ui">
		...
		<div class="inputSet">	
			...
			<div class="inputSet">	
					<div class="label"><span>Class Suffix</span></div>
					<div class="input"><input name="class" type="text" value="<?=$item->class_suffix;?>" /></div>
					<div class="clear"></div>
			</div>
			<div class="inputSet">	
					<div class="label"><span>Id Suffix</span></div>
					<div class="input"><input name="id" type="text" value="<?=$item->id_suffix;?>" /></div>
					<div class="clear"></div>
			</div>
		<div class="inputSet">	
