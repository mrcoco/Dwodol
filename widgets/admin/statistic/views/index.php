		...
		$(document).ready(function(){
			...
			function get_ga_data(){
					$.ajax({
						type: "POST",
						dataType : "json",
						data : {'type' : 'json', 'route' : 'backend/widget/ga_chart_visit_req' },	
						url: "<?=site_url('ajax/post?exe=widget_cont/go&w=admin/statistic/statistic/request_report&idw='.$this->meta->id)?>",
...
//										reportContent = {data : ga_data_extract(value.data), name : value.name};
										value.data = ga_data_extract(value.data);
